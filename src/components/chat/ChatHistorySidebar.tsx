    ...
    <div className="flex flex-col h-full w-full bg-card shrink-0">
      ...
      <div className="flex items-center justify-between h-11.75 px-3 shrink-0 border-b border-border">
        ...
        <button
          type="button"
          onClick={onNewChat}
          className="flex items-center gap-1.5 px-2.5 py-1 rounded-md text-xs font-medium text-primary bg-primary/10 hover:bg-primary/20 transition-colors"
        >
          <Plus size={12} />
          Nuevo
        </button>
      ...
      <div className="px-3 py-2 shrink-0">
        <div className="flex items-center gap-2 bg-muted/60 dark:bg-white/4 border border-border rounded-lg px-2.5 py-1.5">
