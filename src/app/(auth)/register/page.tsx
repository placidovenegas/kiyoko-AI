  ...
  return (
    <div className="rounded-2xl bg-surface p-8 shadow-dialog">
      ...
      <button
        ...
        disabled={loading}
        className="flex w-full items-center justify-center gap-3 rounded-lg border border-surface-tertiary bg-surface px-4 py-2.5 text-sm font-medium text-foreground transition hover:bg-surface-secondary disabled:opacity-50"
      >
